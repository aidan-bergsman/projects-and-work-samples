...
p_load(readxl,janitor,ggplot2,plotly)
...
The graph looks exactly the same, but if you hover over the data points we can see the actual total sales amount for 2016 and 2017. Now we see that sales fell from $40,484.64 in 2016 to $ 6,477.34 in 2017.
...
## Average sales by department in each market

After observing the annual sales changes for two markets, I am curious what the sales from each department look like in each market. I can create a bar graph that visualizes this data,